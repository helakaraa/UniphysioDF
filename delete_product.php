...
$errmsg="";
  ...
  $id=base64_decode($_GET['product']);
   //Define the query
  $sql="DELETE FROM `artigos` WHERE `item_id` =$id";
  $r=$conn->query($sql);
    if($r){
        $msg= "O Artigo foi removido.<br>";
        $err=false;
    }
    else
    {
        $err=true; 
        $errmsg.= "Artigo nao foi removido.<br>";
    }
          ...
          <?php
            ...
            <div class="data-fluid">
                <table cellpadding="0" cellspacing="0" width="100%" class="table images lcnp">
                    ...
                    $slide_sql="SELECT `item_id`, `item_name`, `item_image`,  `item_active` FROM `artigos` LIMIT $start_from, $num_rec_per_page";
                        ...
                        while($row=$slides->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_product.php?product=<?php echo $id; ?>" class="button red">
