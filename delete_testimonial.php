...
$errmsg="";
  ...
  $id=base64_decode($_GET['testimonial']);
   //Define the query
  $sql="DELETE FROM `testomonial`  WHERE `testmonial_id` =$id";
  $r=$conn->query($sql);
    if($r){
        $msg= "O testomonial foi removido.<br>";
        $err=false;
    }
    else
    {
        $err=true; 
        $errmsg.= "O testomonial nao foi removido.<br>";
    }
                        ...
                        while($row=$slides->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_testimonial.php?testimonial=<?php echo $id; ?>" class="button red">
