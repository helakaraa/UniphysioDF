...
if(isset($_POST['save'])){
    ...
    if($r){
        $err=false;
        $errmsg="Detalhes do testemunho guardados com sucesso";
    }else{
        $errmsg="Detalhes do Testemunho não foram salvos com sucesso";
    }
...
<div class="page-header">
    ...
    <h1>Testemunho <small>Manuseie o testemunho no site</small></h1>
</div>
        ...
        <div class="block">
            ...
            <form id="validate" method="POST" >
                <div class="data-fluid">
                    ...
                    <div class="toolbar bottom tar">
                        <div class="btn-group">
                            <button class="btn" type="submit" name="save">Salvar testemunhol</button>
                        </div>
                    </div>
            ...
            <?php }
                ...
                <div class="alert alert-error alert-dismissible" role="alert">
                    ...
                    <a href="testimonial.php" class="btn btn-warning">Va para Testemunho</a>
                    <a href="dashboard.php" class="btn btn-warning ">Va para Home</a>

                </div>
                <div class="row-fluid">
                    <a href="testimonial.php" class="btn btn-default">Va para Testemunho</a>
