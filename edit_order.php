...
<div class="page-header">
    ...
    <h1>Fatura #<?php echo $dtrow["order_id"]; ?> <small>Data: <?php echo $dtrow["order_time"]; ?></small></h1>
</div>
    ...
    <div class="span12" id="printcontent">
        <?php if($err){ ?>
            <div class="alert alert-success alert-dismissible" role="alert">
                ...
                <strong>Successo!</strong> Status atualizado com sucesso
            </div>
        <?php }?>
        <div class="block">
            <div class="data invoice">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <h4>Fatura</h4>
                        <p><strong>Data Fatura:</strong> <?php echo $dtrow["order_time"]; ?></p>
                        <div class="highlight">
                            <strong>Montante devido: </strong><?php echo $dtrow["order_amount"]; ?> <em>R$</em>
                        </div>
                    </div>
                </div>
        ...
        <div class="row-fluid">
            <form method="post">
                ...
                <div class="span3">
                    <button class="btn" type="submit" name="save">Atualizar o Status</button>
