        ...
        <div class="block">
            ...
            <div class="data-fluid">
                    ...
                    <form  id="validate" method="post">
                        ...
                        <div class="data-fluid">
                            ...
                            <div class="row-form">
                                ...
                                <div class="span6"><input type="text" class="validate[required,minSize[5],maxSize[150]]" placeholder="Nome" name="name" value="<?php echo $name;?>"/></div>
                            </div>
                            ...
                            <div class="row-form">
                                ...
                                <div class="span6">
                                    <input type="password" class="validate[minSize[5],maxSize[150]]" id="password" name="password" placeholder="Senha"/>
                                </div>
                            </div>
                            <div class="row-form">
                                <div class="span3">Confirme a Senha :</div>
                                <div class="span6">
                                    <input type="password" class="validate[equals[password]]" placeholder="Confirme a Senha" />
                                </div>
                            </div>
                            <div class="row-form">
                                <div class="span3">Mobile :</div>
                                <div class="span6">
                                    <input type="text" class="validate[required,minSize[11],maxSize[15]]" placeholder="Numero de telefone" name="tel" value="<?php echo $phone;?>"/>
                                </div>
                            </div>
                            <div class="row-form">
                                <div class="span3">Endereco :</div>
                                <div class="span6">
                                    <textarea class="validate[required,minSize[20],maxSize[250]]" placeholder="Endereco" name="address" ><?php echo $address;?></textarea>
                                </div>
                ...
                <?php }
                    ...
                    <div class="alert alert-error alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Erro!</strong> <br>Perfil nao encontrado<br>

                        <a href="dashboard.php" class="btn btn-warning ">Ir para Home</a>
