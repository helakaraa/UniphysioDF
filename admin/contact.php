...
$postback=true;
    ...
    $r=$conn->query($sql);
    if($r){
        $msg= "Detalhes de contato guardados com sucesso<br>";
        $err=false;
    }
    else{
        $errmsg.= "Desculpe, houve um erro ao salvar os detalhes de contato.<br>";
    }
}
?>
<div class="page-header">
    ...
    <h1>Detalhes do contato<small>Atualize os detalhes da sua empresa</small></h1>
</div>
    ...
    <div class="span12">
        <div class="block">
            ...
            <div class="head purple">
                ...
                <h2>Detalhes de contato da empresa</h2>
            </div>
                ...
                <div class="data-fluid">
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            ...
                            <span class="bottom">E-mail da empresa para contato</span>
                        </div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span9">
                            ...
                            <span class="bottom">Numero PTCL da empresa para contato</span>
                        </div>
                    </div>
                    <div class="row-form">
                    ...
                    <div class="row-form">
                        <div class="span3">Mobile (Alternar):</div>
                        <div class="span9">
                            <div class="input-prepend">
                                <span class="add-on"><i class="icon-bell icon-white"></i></span>
                                <input type="tel" name="mob2" value="<?php echo $mob2; ?>"/>
                            </div>
                            <span class="bottom">Numero de celular da empresa para contato</span>
                        </div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span9">
                            ...
                            <span class="bottom">Endereco da empresa Facebook</span>
                        </div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span9">
                            ...
                            <span class="bottom">Conta do Twitter da empresa</span>
                        </div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span9">
                            ...
                            <span class="bottom">Empresa RSS Feed Link</span>
                        </div>
                    </div>
                    <div class="row-form">
                        ...
                        <div class="span3">
                            ...
                            <span class="bottom">Coordenada do Google Map Y da empresa</span>
                        </div>
                    </div>
                    <div class="row-form">
                    ...
                    <div class="toolbar bottom tar">
                        <div class="btn-group">
                            <button class="btn" type="submit" name="save">Detalhes da atualizacao</button>
                        </div>
                    </div>
