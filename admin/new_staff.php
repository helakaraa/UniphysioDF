...
if(isset($_POST['save'])){
    ...
    if ($_FILES["fileToUpload"]["size"] > 5000000) {
        ...
        $errmsg.= "O arquivo nao e uma imagem.<br>";
        $uploadOk = 0;
    }
...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $r=$conn->query($sql);
            if($r){
                $msg= "O membro da equipe foi salvo com sucesso<br>";
                $err=false;
            }
            else{
                $errmsg.= "Desculpe, houve um erro ao salvar.<br>";
            }
        } else {
...
<div class="page-header">
    ...
    <h1>Membros da equipe <small>Gerencie seu perfil da equipe da empresa</small></h1>
</div>
    ...
    <div class="span12">
        <div class="block">
            ...
            <div class="head yellow">
                ...
                <h2>Detalhes do membro da equipe</h2>
            </div>
